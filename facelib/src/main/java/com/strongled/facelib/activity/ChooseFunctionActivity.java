...
import com.strongled.facelib.fragment.ChooseDetectDegreeDialog;
import java.io.File;
...
public class ChooseFunctionActivity extends BaseActivity {
    ...
    String[] permissions = new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.CAMERA, Manifest.permission.RECORD_AUDIO};
