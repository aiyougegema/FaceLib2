package com.strongled.facelib.common;

public class Constants {

    public static final String APP_ID = "81CiKqfXD3VSHNsUAsLoq4GNVf4hJXoJvfcukaXEqZP5";
    public static final String SDK_KEY = "Acm4aPEvRUKpvHaAdbdQeKuboQ1Q9dWRFaQER7VQKmuP";
